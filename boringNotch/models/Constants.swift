...
extension Defaults.Keys {
    ...
    static let liquidGlassDynamicIsland = Key<Bool>("liquidGlassDynamicIsland", default: false)
    static let enableDynamicIslandNotifications = Key<Bool>("enableDynamicIslandNotifications", default: true)
    static let openIslandForNotifications = Key<Bool>("openIslandForNotifications", default: false)
    static let notificationPopupDuration = Key<Double>("notificationPopupDuration", default: 3.0)
    static let enableChargingNotifications = Key<Bool>("enableChargingNotifications", default: true)
    static let enableBatteryStatusNotifications = Key<Bool>("enableBatteryStatusNotifications", default: true)
    static let enableFocusNotifications = Key<Bool>("enableFocusNotifications", default: true)
